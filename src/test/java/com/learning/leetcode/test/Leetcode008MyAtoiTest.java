 ...
 */
public class Leetcode008MyAtoiTest extends BaseTest {

    public static void main(String[] args) {
        int result = new Leetcode008MyAtoiTest().myAtoi(" +-2 ");
    ...
    public int myAtoi(String str) {
        ...
        for(int i = 0; i < chars.length; i++){
            ...
            if(i == 1 && !Character.isDigit(c)){
                ...
                if(neg && (num * -1 < Integer.MIN_VALUE)) return Integer.MIN_VALUE;
            }else if(i == 0){
                return 0;
            }else{
                break;
